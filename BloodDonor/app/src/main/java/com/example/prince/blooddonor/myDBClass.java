...
public class myDBClass  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_MEMBER +
                ...
                " Name TEXT(100)," +"Blood Text(100),"+"Email Text(100),"+"Phone Text(100),"+"Date Text(100),"+
                " Address Text TEXT(100));");
        Log.d("CREATE TABLE", "Create Table Successfully.");
    }

    // Insert Data

    public long InsertData(String strMemberID, String strName, String strBlood,String strEmail,String strPhone,String strDate,String strAddress) {
        try {
            SQLiteDatabase db;
...
// Select Data
            ...
            if(cursor != null)
            {
                if (cursor.moveToFirst()) {
                    ...
                    do {
                        ...
                        map.put("Blood", cursor.getString(2));
    ...
    // Update Data
    public long UpdateData(String strMemberID,String strName,String strBlood,String strEmail,String strPhone,String strDate,String strAddress) {
